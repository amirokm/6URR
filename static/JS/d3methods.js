const Background = function() {
    ...
    obj.addInitialStars = function() {
        ...
        .bind(this)).enter().insert('div').attr('class', 'stars').style('left', function(star) {
    ...
    obj.addStars = function() {
        ...
        d3.select('body').selectAll('.stars').data(this.stars).enter().append('div').attr('class', 'stars').style('left', function() {
